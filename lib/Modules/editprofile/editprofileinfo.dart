...
class _createnewaccountState extends State<editprifile> {
  ...
  void initState() {
    ...
    name.text=x.user.name;
    mobile.text=x.user.mobilenumber;
    email.text=x.user.email;
    password.text=x.user.password;
    confirmpassword.text=x.user.confirmpassword;
    birthDate=x.user.birthdate;
    block.text=x.user.block.toString();
    Floor.text=x.user.Floor.toString();
    Appointmnet.text=x.user.Appointment.toString();
    building.text=x.user.Building.toString();
    street.text=x.user.Street;
    selectedCity=x.user.city;
    selectedArea=x.user.area;
  }
            ...
            child: ListView(
              ...
              children: [
                field('Email Address'.tr, Icons.email, TextInputType.emailAddress,
                    false, email, emailKey,x.user.email,(MediaQuery.of(context).size.width)),
                field('Full Name'.tr, Icons.person, TextInputType.text, false,
                    name, nameKey,x.user.name,(MediaQuery.of(context).size.width)),
                Column(
                  children: [
                    field(
                        'Mobile Number'.tr,
                        ...
                        false,
                        mobile,
                        mobileNumberKey,x.user.mobilenumber,(MediaQuery.of(context).size.width)),
                    Text(
                ...
                field('Password'.tr, Icons.lock, TextInputType.text, pressed,
                    password, passwordKey,x.user.password,(MediaQuery.of(context).size.width)),
                field('Confirm Password'.tr, Icons.lock, TextInputType.text,
                    pressed, confirmpassword, ConfirmPasswordkey,x.user.confirmpassword,(MediaQuery.of(context).size.width)),
                ListTile(
                  title: Text(
                    'Date of Birth'.tr,
                    style: TextStyle(
                ...
                field('Address Street'.tr, Icons.location_city, TextInputType.text,
                    false, street, streetKey,x.user.Street.toString(),(MediaQuery.of(context).size.width)),
                    ...
                    child: Row(
                      ...
                      children: [
                        field('Floor Number'.tr, Icons.home, TextInputType.number, false,
                            Floor, floorNumberKey,x.user.Floor.toString(),constraintss.maxWidth*0.45),
                        field('Flat Number'.tr, Icons.home, TextInputType.number, false,
                            Appointmnet, flatNumberKey,x.user.Appointment.toString(),constraintss.maxWidth*0.45),
                      ],
                    ),
                  ),
                ),
                    ...
                    child: Row(
                      ...
                      children: [
                        field('Block Number'.tr, Icons.home, TextInputType.number, false,
                            block, blockNumberKey,x.user.block.toString(),constraintss.maxWidth*0.45),
                        field('Building Number'.tr, Icons.apartment, TextInputType.number,
                            false, building, apartmentNumberKey,x.user.Building.toString(),constraintss.maxWidth*0.45),
                      ],
                    ),
                  ),
                ),
                // field('Block Number'.tr, Icons.home, TextInputType.number, false,
                //     block, blockNumberKey,x.user.block.toString()),
                // field('Building Number'.tr, Icons.apartment, TextInputType.number,
                //     false, building, apartmentNumberKey,x.user.Building.toString()),
                // field('Floor Number'.tr, Icons.home, TextInputType.number, false,
                //     Floor, floorNumberKey,x.user.Floor.toString()),
                // field('Flat Number'.tr, Icons.home, TextInputType.number, false,
                //     Appointmnet, flatNumberKey,x.user.Appointment.toString()),
  ...
  field(String label, IconData icon, TextInputType type, bool obsecure,
      TextEditingController controller, Key key,String initvalue,double width) {
    return Padding(

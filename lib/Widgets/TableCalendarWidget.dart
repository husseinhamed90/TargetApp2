...
class TableCalendarWidget extends StatefulWidget {
  ...
  TableCalendarWidget(this.currentcollection,this.rowHight,this.calendarController,this.currentEvents,this.mealsmap,this.selectedEvents);
    ...
    return ValueListenableBuilder<Map<DateTime, List<List<meal>>>>(
          ...
          builder: (context, value, child) {
            return TableCalendar(
              ...
              //  isHoliday=appProviderInstance.currentcollection.dayss.dayoff.contains(dayy.weekday);
                  ...
                  if (value[dayy] == null) {
                    ...
                    for (int i = 0; i < value[dayy].length; i++) {
                      if (value[dayy][i].length > 0) {
                        if (value[dayy][i][0].mealcategory ==
                            Categories.Launch) {
                          appProviderInstance.chossenlaunchmeals = value[dayy][i];
                        } else if (value[dayy][i][0].mealcategory ==
